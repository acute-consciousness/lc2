...
public class Lc2Application implements CommandLineRunner{
	...
	private Account serviceLyr; //have not yet understood, understood final. And it says, only, only finals are  permitted and for now Autowired , i see, i see have final ...(interpretation, interpretation for now)
	...
	private Lc2Application(Account serviceLyr){//not static keywords, mmh, keywords, keywords in the constructor. The, the, the, the debugger, the, the, the debugger actually told me that, nah, juu 
		this.serviceLyr =serviceLyr;
	}
