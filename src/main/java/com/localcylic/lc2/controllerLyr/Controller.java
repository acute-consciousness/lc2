...
//@responseBody
//@,@,@,@reodyponseBody
@RequestMapping("/users")//@, at,at, at RequestMapping, defines the base, defines the base URL path for, for, for, for, for, for the controller
//some /api/user...
 ...
 */
	...
	public void addUser() {//kwanza withouth arguments, that will be later, i imagine when data comes, comes, mmh, comes, mmh for the client, but yeah we can as param, no, no i don;'t, i don't know what i'm saying
		...
		String key="700000000",userName = "eric", phoneNumber = "700000000", email = "eric@email.com", password = "pass1", lattitude = "56.823", longitude  = "21.68";
		serviceLyrReference.addUser(key,userName,phoneNumber,email,password,lattitude,longitude);
	}
	
	
	//This has wroks lakini we, vibe coding mbaya
	@GetMapping("/testDatabase")//this is here just to test if hibernate is working...you know, doing things in postgresql
	public java.util.List<User> getAllUsers() {// major error - this should not be static, get to understand why this was the reason
